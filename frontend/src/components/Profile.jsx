...
const ProfileEdit = () => {
  ...
  const handleSubmit = (event) => {
    ...
    axios
      .post("https://cric-insight-blush.vercel.app/api/user/updateUser", updatedData)
      .then((response) => {
  ...
  const handleDelete = () => {
    setOpen(false);
    axios
      .delete(`https://cric-insight-blush.vercel.app/api/user/deleteUser?email=${profileData.email}`)
      .then((response) => {
